...
@section('title', 'Creatinas - NutriShop')

@section('content')
<main class="container my-5">
    <div class="mb-4">
        <h2 class="fw-bold">⚡ Creatinas</h2>
        <p class="text-muted">Potencia tu fuerza y resistencia muscular</p>
    </div>
    ...
    <div class="text-center py-5">
        ...
        <h4 class="text-muted">No hay creatinas disponibles en este momento</h4>
