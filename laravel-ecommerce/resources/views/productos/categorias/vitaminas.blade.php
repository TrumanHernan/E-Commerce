...
@section('title', 'Vitaminas - NutriShop')

@section('content')
<main class="container my-5">
    <div class="mb-4">
        <h2 class="fw-bold">🍊 Vitaminas</h2>
        <p class="text-muted">Refuerza tu sistema inmunológico y salud general</p>
    </div>
    ...
    <div class="text-center py-5">
        ...
        <h4 class="text-muted">No hay vitaminas disponibles en este momento</h4>
