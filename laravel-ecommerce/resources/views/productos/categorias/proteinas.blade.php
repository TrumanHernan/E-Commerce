...
@section('title', 'Proteínas - NutriShop')

@section('content')
<main class="container my-5">
    <div class="mb-4">
        <h2 class="fw-bold">💪 Proteínas</h2>
        <p class="text-muted">La mejor selección de proteínas para tu rendimiento</p>
    </div>
    ...
    <div class="text-center py-5">
        ...
        <h4 class="text-muted">No hay proteínas disponibles en este momento</h4>
